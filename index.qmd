...
[Pre-course tasks](/pre-course/overview.qmd) to get set up and ready
for the course. The pre-course tasks include a survey that you need
to fill out before the course starts.
...
4.  For those who are **interested in teaching**, who may not have much
    ...
    guide to running and teaching their own courses.
...
The course material is created using [Quarto](https://quarto.org) to
