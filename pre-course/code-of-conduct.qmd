...
throughout the course, in group work, and any activity associated with
this course.
...
code throughout the course, but you may also contact us privately; all
communication will be treated as confidential.

The code of conduct applies to all spaces associated with this course
...
Thank you for helping make this a welcoming, friendly course for all
:smile:

::: {.callout-note appearance="default"}
*Acknowledgements*: This code of conduct was borrowed from [R3 by rostools](https://r-cubed-intro.rostools.org/).
Large portions of this code of conduct were taken and modified from other codes of conduct, specifically [Software
