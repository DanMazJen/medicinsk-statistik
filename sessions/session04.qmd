...
Project...". A new pop-up window shows up. Click "New directory" and select "New
Project". Type out `plotting-data` as the directory name and save it to the
`Desktop/` (or where you want to store your project).

Finally, while you're in the project (see top right `plotting-data`), run:

```r
medisr::medisr_init_project
```
